...
![パイプライン全体の俯瞰図](/images/00-overview.png)
...
![ベクトル化：トークンからエンコーダを通って1024次元の矢印になる](/images/02-embed.png)
![知識検索：質問ベクトルを軸にした円錐がしきい値、内側の知識がヒット](/images/03-retrieve.png)
![応答生成：次トークン確率の棒グラフ → 選択 → 末尾に追加を繰り返す](/images/05-generate.png)
